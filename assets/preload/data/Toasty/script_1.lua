...
IntroAristTextSize = 20
IntroTagColor = 'ffa600'	--Color of the tag at the end of the box.
...
function onCreate()
	...
	--the text for the "artist" name
	makeLuaText('JukeArtist', 'by Ne1tor', 300, -305-IntroTagWidth, 240)
	setTextAlignment('JukeArtist', 'right')
	setObjectCamera('JukeArtist', 'other')
	setTextSize('JukeArtist', IntroAristTextSize)
	addLuaText('JukeArtist')
...
function onSongStart()
	...
	doTweenX('MoveInFour', 'JukeArtist', 0, 1, 'CircInOut')
	doTweenX('MoveInFive', 'JukeBoxSubText', 0, 1, 'CircInOut')
...
function onTimerCompleted(tag, loops, loopsLeft)
	if tag == 'JukeBoxWait' then
		...
		doTweenX('MoveOutFour', 'JukeArtist', -450, 1.5, 'CircInOut')
		doTweenX('MoveOutFive', 'JukeBoxSubText', -450, 1.5, 'CircInOut')
	end
end