function onCreate() --FUCKING SHIT FUCK FUCK FUCKITY FUCKING SPAGHETTI CODE FUCKING SHIT BALLS SHIT CRAP PISS FUCKING SHIT
	...
	makeAnimatedLuaSprite('AwardIcon', 'Awards/Scorpion1-Award', 10, 450)
...
function onEvent(name, value1, value2)
	...
	if name == 'AwardCheck1' then
		if value1 == 'fc' then
			if getProperty('songMisses') < 9999 then
				--text shit
				setTextString('AwardTitle', 'GET OVER HERE!')
				setTextString('AwardSub', 'win against scorpion')
