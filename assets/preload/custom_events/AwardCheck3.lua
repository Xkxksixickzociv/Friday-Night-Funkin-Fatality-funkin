function onCreate() --FUCKING SHIT FUCK FUCK FUCKITY FUCKING SPAGHETTI CODE FUCKING SHIT BALLS SHIT CRAP PISS FUCKING SHIT
	...
	makeAnimatedLuaSprite('AwardIcon', 'Awards/mileena-Award', 10, 450)
	...
	makeLuaText('AwardSub', 'Sample Text', 200, 125, 520)
...
function onEvent(name, value1, value2)
	...
	if name == 'AwardCheck3' then
		if value1 == 'fc' then
			if getProperty('songMisses') < 9999 then
				--text shit
				setTextString('AwardTitle', 'WHERE ARE THE NAILS?')
				setTextString('AwardSub', 'win against mileena')
